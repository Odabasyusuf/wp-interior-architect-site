	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Greenhash Home 1', 'greenhash' ),
				'page'  => __( 'Home', 'greenhash' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home1.png',
				'preview_link' => 'https://shtheme.org/demosd/greenhash/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Greenhash Home 2', 'greenhash' ),
				'page'  => __( 'Home 2', 'greenhash' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home2.png',
				'preview_link' => 'https://shtheme.org/demosd/greenhash/?page_id=53',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import Greenhash Home 3', 'greenhash' ),
				'page'  => __( 'Home 3', 'greenhash' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/home3.png',
				'preview_link' => 'https://shtheme.org/demosd/greenhash/?page_id=57',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'greenhash' ),
			);
		}
