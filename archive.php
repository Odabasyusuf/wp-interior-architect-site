            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="page-title-content">
                  ...
                  if ( is_day() ) :
                    ...
                    printf( esc_html__( 'Daily Archives: %s', 'greenhash' ), get_the_date() );



                  elseif ( is_month() ) :

                    printf( esc_html__( 'Monthly Archives: %s', 'greenhash' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'greenhash' ) ) );



                  elseif ( is_year() ) :

                    printf( esc_html__( 'Yearly Archives: %s', 'greenhash' ), get_the_date( _x( 'Y', 'yearly archives date format', 'greenhash' ) ) );



                  else :

                    echo esc_html__( 'Archives', 'greenhash' );
