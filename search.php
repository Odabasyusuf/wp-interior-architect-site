        ...
        <div class="row align-items-center">
            <div class="col-xl-12 col-lg-12">
                <div class="page-title-content">
                  <h2><?php printf( esc_html__( 'Search Results for: %s', 'greenhash' ), get_search_query() ); ?></h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="blog-details-wrapper theme-bg-2">
                    <div class="row">
                        ...
                        ?> 
                          ...
                          echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'greenhash' ) ;?></h4>
